...
public class ExampleActivity extends AppCompatActivity {
    ...
    TextView textStatus, textIntValue, textStrValue, client;
    ...
    class IncomingHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case ExampleService.MSG_SET_INT_VALUE:
                    textIntValue.setText("Int Message: " + msg.arg1);
                    break;
                case ExampleService.MSG_SET_STRING_VALUE:
    ...
    private OnClickListener btnStartListener = new OnClickListener() {
        public void onClick(View v){
            startService(new Intent(ExampleActivity.this, ExampleService.class));
        }
    };
    private OnClickListener btnStopListener = new OnClickListener() {
        public void onClick(View v){
            doUnbindService();
            stopService(new Intent(ExampleActivity.this, ExampleService.class));
        }
    };
    ...
    private void sendMessageToService(int intvaluetosend) {
        if (mIsBound) {
            if (mService != null) {
                try {
                    Message msg = Message.obtain(null, ExampleService.MSG_SET_INT_VALUE, intvaluetosend, 0);
                    msg.replyTo = mMessenger;
                    mService.send(msg);
                }
                catch (RemoteException e) {
